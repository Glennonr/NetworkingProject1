...
import time
"""
This program runs a TCP protocol chat client and server. Type 'client' or 'server' as an argument 
"""
...
async def main():
    ...
    """
    parser = argparse.ArgumentParser(description='TCP Server Client Chat Room')
    parser.add_argument('--port', type=int, help='The port to bind to', default=2568)
    ...
    if args.cmd == 'server':
        await connection.run_server(args.port)
